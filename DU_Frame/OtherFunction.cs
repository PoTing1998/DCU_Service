...
namespace DuFrame
{
    ...
    public class Method
    {
        ...
        //每五秒為單位轉成byte
      static  public byte[] ConvertToByteArray(int seconds)
        {
        ...
        //一個int轉成一個 byte
        static public byte[] OneByte(int I )
        {
        ...
        static public byte[] FromRgb(int r, int g, int b)
        {
            ...
            arrReturn[0] = (byte)(r & 0xFF);
            arrReturn[1] = (byte)(g & 0xFF);
            arrReturn[2] = (byte)(b & 0xFF);
