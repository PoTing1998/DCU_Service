...
namespace ASI.Wanda.DCU.TaskSDU
{
    ...
    public class TaskSDUHelper
    {
        ...
        private const string Pattern = @"LG01_SDW_SDU-5"; // 定義要篩選的模式
        public const string _mDU_ID = "LG01_SDW_SDU-5";
        ...
        private List<DisplayMessageResult> CreateAndSendMessage(string targetDu, string dbName1, string dbName2)
        {
            ...
            try
            {
                ...
                if (dbName1 == "dmd_instant_message")
                {
                    ...
                    ASI.Lib.Log.DebugLog.Log(_mProcName, "SDU 即時訊息處理尚未實作");
                }
                ...
                else if (dbName1 == "dmd_train_message")
                {
                    ...
                    ASI.Lib.Log.DebugLog.Log(_mProcName, "SDU 列車訊息批量處理尚未實作");
                }
            }
            catch (Exception ex)
            {
